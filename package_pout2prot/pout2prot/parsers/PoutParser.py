...
class PoutParser(Parser):
    """
    Parser for .pout-files as they are produced by the Percolator tool.
    """
    def parse(my_path, fdr_threshold, decoy_flag, sample_categories_flag):
